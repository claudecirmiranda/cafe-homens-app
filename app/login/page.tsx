  ...
  return (
    <>
      ...
      <main className="px-6 py-10">
        ...
        <button
          onClick={() => alert('OAuth Google será implementado em breve.')}
          className="mt-6 w-full flex items-center justify-center gap-3 bg-white border
                     border-brand-ocre rounded-xl py-3 font-sans text-sm text-brand-dark
